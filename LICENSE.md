...
> Discord stream and VOD notifier bot for YouTube Twitch 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🎮 &nbsp;**Multi-platform** — YouTube, Twitch, Kick, TikTok Live

🔔 &nbsp;**Go-live alerts** — posted to Discord instantly

🖼️ &nbsp;**Rich embed** — thumbnail, title, viewers in embed

📢 &nbsp;**Role ping** — @ notify a role on stream start

📅 &nbsp;**Schedule** — show upcoming stream schedule

📊 &nbsp;**Stats** — average viewers and stream duration
